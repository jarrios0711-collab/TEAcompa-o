...
export default function Comunidad() {
  ...
  const publicarTestimonio = async () => {
    ...
    setTestimonio("");
    setShowForm(false);
    cargarTestimonios(); // recargar la lista automáticamente
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="section-title">
            Voces que inspiran, experiencias que guían
          </h2>
        ...
        <div className="grid lg:grid-cols-5 gap-8">
                ...
                <div key={t.id} className="card hover:shadow-md transition-shadow">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {t.terapia && (
                        <span className="inline-block mt-2 text-xs text-brand-600 bg-brand-50 px-2.5 py-1 rounded-full font-medium">
                          {t.terapia}
                        </span>
                      )}
                    </div>
          ...
          {/* Sidebar: Consejos desde Supabase */}
            ...
            <div className="card bg-gradient-to-br from-brand-50 to-aqua-50 border-brand-100">
              ...
              {!showForm ? (
                ...
                <div className="space-y-3">
                  ...
                  />
                  <textarea
                    placeholder="Comparte tu historia, consejo o experiencia..."
                    rows={4}
                    value={testimonio}
                  ...
                  <div className="flex gap-2">
                    <button
                      onClick={publicarTestimonio}
                      className="btn-primary text-sm !py-2 flex-1"
                      disabled={!testimonio.trim() || !nombre.trim() || enviando}
                    >
                      {enviando ? "Publicando..." : "Publicar"}
                    </button>
                    <button
                      onClick={() => { setShowForm(false); setNombre(""); setTestimonio(""); }}
